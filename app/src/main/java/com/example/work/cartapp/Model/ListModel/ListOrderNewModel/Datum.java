...
public class Datum {
    ...
    private List<com.example.work.cartapp.Model.ListModel.ListOrderNewModel.SalesOrderDetailsList> mSalesOrderDetailsList;
    @SerializedName("Sales_Order_Id")
    private String mSalesOrderId;
    @SerializedName("Shop_Details")
    private com.example.work.cartapp.Model.ListModel.ListOrderNewModel.ShopDetails mShopDetails;
    ...
    public List<com.example.work.cartapp.Model.ListModel.ListOrderNewModel.SalesOrderDetailsList> getSalesOrderDetailsList() {
        return mSalesOrderDetailsList;
    }

    public void setSalesOrderDetailsList(List<com.example.work.cartapp.Model.ListModel.ListOrderNewModel.SalesOrderDetailsList> SalesOrderDetailsList) {
    ...
    public com.example.work.cartapp.Model.ListModel.ListOrderNewModel.ShopDetails getShopDetails() {
        return mShopDetails;
    }

    public void setShopDetails(com.example.work.cartapp.Model.ListModel.ListOrderNewModel.ShopDetails ShopDetails) {
